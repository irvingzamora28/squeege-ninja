            ...
            <div className="flex items-center">
              ...
              <nav className="ml-6 hidden md:block">
                <div className="flex space-x-4">
                  ...
                  <NavLink href="/allset/services">Services</NavLink>
                  <NavLink href="/allset/schedule">Schedule</NavLink>
                  ...
                  <NavLink href="/allset/agent">Agent</NavLink>
      ...
      <div className="border-b border-gray-200 bg-slate-100 py-2 md:hidden dark:border-gray-700 dark:bg-gray-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between space-x-2 overflow-x-auto">
            ...
            <NavLink href="/allset/services" className="whitespace-nowrap">
              Services
            </NavLink>
            <NavLink href="/allset/schedule" className="whitespace-nowrap">
              Schedule
            </NavLink>
            ...
            <NavLink href="/allset/agent" className="whitespace-nowrap">
              Agent
            </NavLink>
